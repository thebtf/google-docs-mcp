...
const SCOPES = [
  ...
  'https://www.googleapis.com/auth/drive.readonly', // Read-only Drive access for listing and searching documents
...
async function authenticate(): Promise<OAuth2Client> {
  ...
  // Use configured redirect URI for all client types (OOB is deprecated)
